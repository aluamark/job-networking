			...
			<div className="min-h-screen h-screen flex flex-col">
				<div className="relative h-full">
					<div className="fixed mt-[3.8rem] bg-base-100 border border-base-300 w-full">
						<div className="max-w-screen-xl mx-auto flex items-center gap-1.5 py-5 px-3">
					...
					<div className="max-w-screen-xl h-full mx-auto flex divide-x divide-base-300 bg-base-100 border border-base-300 w-full pt-[10rem]">
						<div className="relative flex-1 h-full">
							...
							<ul className="flex flex-col divide-y divide-base-300 h-[94.8%] overflow-y-auto">
